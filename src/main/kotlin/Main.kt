...
private fun reportHttpTransactions(analytics: Analytics) = ReportHttpTransaction(
    recordFn = { analytics(HttpEvent(it)) }
)

private fun catchAll(analytics: Analytics) = CatchAll { e ->
    analytics(UncaughtExceptionEvent(e))
